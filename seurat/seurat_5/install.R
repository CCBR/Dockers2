...
remotes::install_github("chris-mcginnis-ucsf/DoubletFinder@67fb8b5", upgrade = "never")
...
abort_packages_not_installed('SeuratWrappers', 'DoubletFinder', 'Routliers', 'BPCells', 'gypsum')
